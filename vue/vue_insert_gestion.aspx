...
<form method="post" class="form-horizontal border border-insert-offre">
	...
	<div class="form-group row">
        ...
        <div class="col-md-6">
            ...
            <input type="number" class="form-control champ-insert-offre" name="idusertache" id="idusertache"  value="<%=(laTache!= null) ? laTache.Id_user.ToString() : "" %>">
        </div>
...
<form method="post" class="form-horizontal border border-insert-offre">
	...
	<div class="form-group row">
        ...
        <div class="col-md-6">
            <label class="margin-label" for="id">ID</label>
            <input type="number" class="form-control champ-insert-offre" name="iduserpaie" id="iduserpaie"  value="<%=(laPaie!= null) ? laPaie.Id_user.ToString() : "" %>">
        </div>

        <div class="col-md-6">
            <label class="margin-label" for="montant">Montant</label>
            <input type="number" class="form-control champ-insert-offre" name="montantpaie" id="montantpaie" step=".01" value="<%=(laPaie!= null) ? laPaie.Montant.ToString() : "" %>">
        </div>
